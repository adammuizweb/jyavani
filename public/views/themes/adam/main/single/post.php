...
<?php
$siteTitleJson = $site['title'] ?? 'Adamz Code';
$siteUrlJson   = rtrim($site['url'] ?? '/', '/');
?>
...
<?= json_encode([
  ...
  'publisher' => [
    ...
    'logo' => [
      '@type' => 'ImageObject',
      'url' => $siteUrlJson . '/static/img/jyavani.svg'
    ]
  ],
  'datePublished' => $datePublished,
  'dateModified' => $dateModified ?: $datePublished,
  'description' => mb_strimwidth(safe_strip_tags(html_entity_decode((string)($post['content'] ?? ''), ENT_QUOTES, 'UTF-8')), 0, 160, '...')
