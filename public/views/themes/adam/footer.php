...
$copyright = $tcFooterText !== '' ? $tcFooterText : '&copy; <span id="year"></span> ' . htmlspecialchars($siteTitle, ENT_QUOTES, 'UTF-8') . '. ' . __('Released under MIT License.');
...
<footer class="site-footer fade-up onload" data-duration="1000" data-anime-trigger="load" role="contentinfo">
  <div class="footer-container">
    ...
    <?php else: ?>
    <div class="footer-row-bottom">
      <div class="copyright-text typewrite onload" data-duration="1000" data-anime-trigger="load">
        <?= $copyright ?>
      </div>
    </div>
    <?php endif; ?>
