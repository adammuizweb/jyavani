...
<section class="adam-pages-list">
  <header class="adam-pages-list__header" aria-labelledby="adam-pages-title">
    <h1 id="adam-pages-title" class="adam-pages-list__title">Halaman</h1>

    <?php if ($total): ?>
      <div class="adam-pages-list__count" aria-live="polite">
        <?= htmlspecialchars(number_format($total), ENT_QUOTES, 'UTF-8') ?> halaman terdaftar
      </div>
    <?php endif; ?>
  </header>
          ...
          <div class="adam-pages-list__item-main">
            ...
            <?php if ($dateLabel): ?>
              <div class="adam-pages-list__meta">
                <time datetime="<?= $date ?>" class="adam-pages-list__date">Dibuat <?= $dateLabel ?></time>
              </div>
            <?php endif; ?>
          </div>
