...
if (($_SERVER['REQUEST_METHOD'] ?? '') !== 'POST') {
  adiwira_json(['success'=>false,'ok'=>false,'error'=>'Method not allowed'], 405);
}
...
// lokasi /static/img (pakai PUBLIC_PATH dari bootstrap kamu)
 ...
 * - getimagesize (bagus untuk jpeg/png)
 * - exif_imagetype (kalau ada)
 * - finfo
 * - mime_content_type
 */
...
if ($mime === '' && function_exists('exif_imagetype')) {
  ...
  if ($t) {
    $map = [
      ...
      // IMAGETYPE_WEBP mungkin tidak ada di versi lama PHP, jadi kita cek dulu:
    ];
...
// Allowed (pakai MIME yang benar, bukan "image/jpg")
$allowed = [
  'image/webp' => 'webp',
  'image/png'  => 'png',
  'image/jpeg' => 'jpg',
...
// Kalau MIME masih kosong atau tidak cocok, balikin debug deteksi
