...
if ($role === 'author' && (int)($row['created_by'] ?? 0) !== $uid) {
    adiwira_redirect_with_flash($returnTo, 'error', 'Role kamu tidak punya akses hapus permanen page ini.');
}
...
try {
    ...
    adiwira_redirect_with_flash($returnTo, 'success', 'Page berhasil dihapus permanen.');
    ...
    adiwira_redirect_with_flash($returnTo, 'error', 'Gagal hapus permanen page.');
}