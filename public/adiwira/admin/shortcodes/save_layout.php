...
$return_to = function_exists('adiwira_safe_return_to')
    ? adiwira_safe_return_to((string)($_POST['return_to'] ?? ''), '/adiwira/index.php?page=admin/shortcodes/index&tab=layouts')
    : '/adiwira/index.php?page=admin/shortcodes/index&tab=layouts';
