...
$return_to  = function_exists('adiwira_safe_return_to')
    ? adiwira_safe_return_to((string)($_POST['return_to'] ?? ''), '/adiwira/index.php?page=admin/shortcodes/index&tab=presets')
    : '/adiwira/index.php?page=admin/shortcodes/index&tab=presets';
...
if (!empty($errors)) {
    ...
    $redirect = $isEdit
        ? '/adiwira/index.php?' . http_build_query(['page' => 'admin/shortcodes/edit', 'id' => $id, 'return_to' => $return_to])
        : '/adiwira/index.php?page=admin/shortcodes/edit';
