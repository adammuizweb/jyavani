...
if (!adiwira_csrf_validate($csrf)) {
    theme_save_error_response(['CSRF invalid'], '/adiwira/index.php?page=admin/themes/index', 419);
}
...
$return_to  = function_exists('adiwira_safe_return_to')
    ? adiwira_safe_return_to((string)($_POST['return_to'] ?? ''), '/adiwira/index.php?page=admin/themes/index')
    : '/adiwira/index.php?page=admin/themes/index';
