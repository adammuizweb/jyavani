...
/* VIEWS_BASE detection */
if (!defined('VIEWS_BASE')) {
    $try1 = PUBLIC_PATH . '/views/theme';
    $try2 = PUBLIC_PATH . '/views/themes';
    if (is_dir($try1)) {
        define('VIEWS_BASE', realpath($try1));
    } elseif (is_dir($try2)) {
        define('VIEWS_BASE', realpath($try2));
    } else {
        define('VIEWS_BASE', realpath($try1) ?: $try1);
    }
}
if (!defined('DEFAULT_THEME_FOLDER')) define('DEFAULT_THEME_FOLDER', 'default');
