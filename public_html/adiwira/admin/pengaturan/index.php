...
if ($role === 'admin') {
    ...
    $links[] = ['label' => 'Website', 'href' => $base . '/index.php?page=admin/pengaturan/site'];
}
...
<section style="max-width:820px;margin:18px auto;padding:0 12px">
  ...
  <nav aria-label="Pengaturan utama" style="border:1px solid #eee;border-radius:8px;background:#fff;padding:12px">
