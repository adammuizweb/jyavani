...
<div class="up-grid">
    <div class="up-card">
        ...
        <table class="up-table">
            ...
            <tr><td><?=_e('Edition')?></td><td><span style="display:inline-flex;align-items:center;gap:5px;background:linear-gradient(135deg,#f97316,#dc2626);color:#fff;font-weight:600;font-size:.78rem;padding:2px 12px;border-radius:999px;letter-spacing:.02em;box-shadow:0 1px 4px rgba(220,38,38,.3)"><svg viewBox="0 0 24 24" width="14" height="14" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" style="flex-shrink:0"><path d="M8.5 14.5A2.5 2.5 0 0 0 11 12c0-1.38-.5-2-1-3-1.072-2.143-.224-4.054 2-6 .5 2.5 2 4.9 4 6.5 2 1.6 3 3.5 3 5.5a7 7 0 1 1-14 0c0-1.153.433-2.294 1-3a2.5 2.5 0 0 0 2.5 2.5z"/></svg><?= htmlspecialchars($currentVersion['edition'] ?? '—') ?></span></td></tr>
