...
.site-health__disclaimer b{display:block;margin-bottom:3px;color:#a16207}.site-health__signals{position:relative;z-index:2;display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:10px;margin-top:14px}.site-health__signal{--health-color:#64748b;display:flex;align-items:center;gap:11px;min-width:0;padding:13px 14px;border:1px solid color-mix(in srgb,var(--health-color) 42%,var(--adam-border,#e2e8f0));border-inline-start:4px solid var(--health-color);border-radius:14px;background:linear-gradient(135deg,color-mix(in srgb,var(--health-color) 18%,var(--adam-card,#fff)),var(--adam-card,#fff) 72%);color:inherit;text-decoration:none;box-shadow:0 9px 24px color-mix(in srgb,var(--health-color) 13%,transparent);transition:transform .18s ease,border-color .18s ease,box-shadow .18s ease}.site-health__signal[href]{cursor:pointer}.site-health__signal[href]:hover{transform:translateY(-2px);border-color:color-mix(in srgb,var(--health-color) 72%,var(--adam-border,#e2e8f0));box-shadow:0 14px 30px color-mix(in srgb,var(--health-color) 21%,transparent)}.site-health__signal[href]:focus-visible{outline:3px solid color-mix(in srgb,var(--health-color) 38%,transparent);outline-offset:3px}.site-health__signal-icon{display:grid;place-items:center;width:36px;height:36px;flex:0 0 36px;border:1px solid color-mix(in srgb,var(--health-color) 22%,transparent);border-radius:11px;background:color-mix(in srgb,var(--health-color) 18%,transparent);color:var(--health-color)}.site-health__signal-icon svg{width:18px;height:18px}.site-health__signal-copy{min-width:0}.site-health__signal-copy small{display:block;overflow:hidden;color:var(--adam-muted,#64748b);font-size:.68rem;font-weight:700;text-overflow:ellipsis;white-space:nowrap}.site-health__signal-copy strong{display:block;margin-top:2px;color:var(--health-color);font-size:.84rem}.site-health__signal-action{display:grid;place-items:center;width:26px;height:26px;margin-inline-start:auto;flex:0 0 26px;border:1px solid color-mix(in srgb,var(--health-color) 28%,transparent);border-radius:999px;background:color-mix(in srgb,var(--health-color) 14%,transparent);color:var(--health-color);transition:transform .18s ease,background .18s ease}.site-health__signal-action svg{width:14px;height:14px}.site-health__signal[href]:hover .site-health__signal-action{transform:translateX(2px);background:color-mix(in srgb,var(--health-color) 23%,transparent)}.site-health__layout{display:grid;grid-template-columns:minmax(0,1.65fr) minmax(280px,.75fr);gap:16px;margin-top:16px;align-items:start}
...
<section class="site-health">
  ...
  <div class="site-health__signals" aria-label="<?=h(__('Scan Coverage'))?>">
    ...
    <a class="site-health__signal site-health__status-color--<?=h($coreStatus)?>" href="#core-integrity"><span class="site-health__signal-icon" aria-hidden="true"><?=svg_ico('monitor')?></span><span class="site-health__signal-copy"><small><?=_e('Core files')?></small><strong><?=h($statusLabels[$coreStatus]??$statusLabels['unverified'])?></strong></span><span class="site-health__signal-action" aria-hidden="true"><?=svg_ico('chevron-right')?></span></a>
