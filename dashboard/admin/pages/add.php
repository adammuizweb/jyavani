      ...
      <label><?=_e('Status')?><br>
        <select name="status" class="inp">
          ...
          <?php if ($canPublish): ?>
            ...
            <?php if (content_scheduling_enabled($pdo)): ?><option value="scheduled" <?= (($_POST['status'] ?? '') === 'scheduled') ? 'selected' : '' ?>><?= _e('Scheduled') ?></option><?php endif; ?>
          <?php endif; ?>
        </select>
      </label>
      <?php if ($canPublish && content_scheduling_enabled($pdo)): ?>
