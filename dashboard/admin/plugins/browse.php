...
.plugin-store-browser .btn{text-decoration:none}.plugin-card-actions{display:flex;align-items:center;gap:.35rem;padding:.55rem .75rem}.plugin-card-actions .plugin-install-form{display:flex;align-items:center;gap:.35rem;min-width:0}.plugin-card-actions .btn{box-sizing:border-box;display:inline-flex;flex:0 1 auto;align-items:center;justify-content:center;min-width:0;min-height:30px;margin:0;padding:.34rem .58rem;font-size:.74rem;line-height:1.1;text-align:center;white-space:nowrap}.plugin-card-action--primary{font-weight:650}.plugin-card-action--secondary{background:var(--adam-card)}.plugin-card-actions .plugin-card-action--detail{margin-left:auto;padding-inline:.35rem;border-color:transparent;background:transparent;color:var(--adam-muted)}.plugin-card-actions .plugin-card-action--detail:hover{background:var(--adam-surface-3);color:var(--adam-text)}
</style>
