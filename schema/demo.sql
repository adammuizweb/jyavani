...
(272, 'Content Management: Artikel, Halaman, dan Publikasi', 'content-management-mengelola-artikel-dan-halaman', '<p>Jyavani Core menyimpan artikel dan halaman di tabel konten yang sama, tetapi memberi keduanya alur dashboard dan permission terpisah. Artikel dapat memiliki beberapa kategori; halaman tidak memiliki relasi kategori.</p>
...
<h2>Operasi aman</h2>
<p>Isi alt text sesuai fungsi gambar dan optimalkan ukuran sebelum upload. Permission media memisahkan read, upload, update, trash, restore, dan purge serta dapat memakai scope pemilik. Delete awal memindahkan record ke Trash; untuk storage lokal terkelola, Core juga memindahkan file ke penyimpanan non-public. Purge menghapus record dan file secara permanen, sehingga backup tetap diperlukan.</p>
...
(279, 'User Management, Site Owner, Role, dan Scope', 'user-management-mengelola-pengguna', '<p>Jyavani Core memakai role dan permission dinamis. Kolom role lama tetap disinkronkan untuk kompatibilitas, tetapi keputusan akses baru harus memakai permission efektif dan scope.</p>
<h2>Site Owner</h2>
...
', 'page', NULL, NULL, NULL, 'published', 1, 1, '2026-07-24 23:50:53', '2026-08-19 00:00:00', 0, NULL, 0),
(286, 'Recycle Bin dan Soft Delete Konten', 'sistem-soft-delete-recycle-bin', '<p>Recycle Bin Core berlaku untuk artikel, halaman, theme content, kategori, user, Media Library, dan File Library. Setiap resource mempertahankan permission, scope pemilik, serta aturan restore dan purge sendiri.</p>
...
<p>Core tidak menyimpan snapshot status konten sebelum trash di kolom terpisah; status post yang ada tetap pada record. Tidak ada janji auto-clean universal. Untuk media/file pada storage lokal terkelola, trash memindahkan byte ke <code>private_files/.asset-trash</code>, restore mengembalikannya ke path asal yang masih aman, dan purge menghapus byte secara permanen. Trash tetap bukan pengganti backup.</p>
<h2>Prosedur aman</h2>
<ol>
...
(288, 'Memulai dengan Jyavani CMS', 'memulai-dengan-jyavani', '<p>Jyavani CMS adalah CMS native PHP tanpa Composer runtime. Entry publik berada di <code>public/router.php</code>; konfigurasi, dashboard, aplikasi, plugin, schema, dan private files berada di luar web root deployment yang benar.</p>
...
<ol>
  ...
  <li>Biarkan <code>PUBLIC_PATH</code> kosong untuk deteksi web root konvensional, atau isi dengan web root absolut yang sudah ada.</li>
...
<ul>
  ...
  <li><code>editorial</code>: akses internal bagi akun dengan legacy role editorial yang sesuai.</li>
  <li><code>admin</code>: akses administrator yang berwenang.</li>
</ul>
<p>File private berada di <code>private_files/files</code>; gambar private berada di <code>private_files/media</code>. Controller membaca record, sesi, legacy role hierarchy, storage identity, dan path sebelum stream. Jangan menaruh data sensitif pada public disk lalu hanya menyembunyikan URL.</p>
...
<p>Backup public upload dan kedua private storage. Delete awal memindahkan media/file ke Trash; untuk storage lokal terkelola, byte dipindahkan ke penyimpanan non-public dan dapat direstore ke path asal yang masih aman. Purge menghapus record dan byte secara permanen. Uji akses sebagai anonymous, author, editor, admin non-owner, dan Site Owner.</p>
...
(292, 'Plugin Permissions: Default Roles dan Delegability', 'plugin-permissions-default-roles-dan-delegability', '<p>Plugin mendeklarasikan permission miliknya di <code>plugin.json</code>; Core memvalidasi lalu menyinkronkannya ke authorization dinamis.</p>
...
<p>Setiap komponen mempertahankan batas ownership sendiri. Penggunaan hook resmi oleh plugin tidak mengubah file Core. Scanner saat ini hanya menginventaris plugin dan non-system theme; scanner belum mengonsumsi manifest file authoritative dari Store, sehingga extension tetap <code>unverified</code> kecuali artefak tidak aman menaikkan statusnya.</p>
...
(65, '/static/img/2026/07/screenshots/posts-list.jpg', 'posts-list.jpg', 'image/jpeg', 'jpg', 139128, 1280, 720, 'posts-list', 'Screenshot posts-list', NULL, NULL, 'public', 'public', '2026/07/screenshots/posts-list.jpg', 'public', 1, 1, '2026-07-24 10:07:52', NULL, NULL, NULL),
(66, '/static/img/2026/07/screenshots/add-post.jpg', 'add-post.jpg', 'image/jpeg', 'jpg', 61486, 1280, 720, 'add-post', 'Screenshot add-post', NULL, NULL, 'public', 'public', '2026/07/screenshots/add-post.jpg', 'public', 1, 1, '2026-07-24 10:07:52', NULL, NULL, NULL),
(67, '/static/img/2026/07/screenshots/pages-list.jpg', 'pages-list.jpg', 'image/jpeg', 'jpg', 82961, 1280, 720, 'pages-list', 'Screenshot pages-list', NULL, NULL, 'public', 'public', '2026/07/screenshots/pages-list.jpg', 'public', 1, 1, '2026-07-24 10:07:52', NULL, NULL, NULL),
(68, '/static/img/2026/07/screenshots/categories.jpg', 'categories.jpg', 'image/jpeg', 'jpg', 61170, 1280, 720, 'categories', 'Screenshot categories', NULL, NULL, 'public', 'public', '2026/07/screenshots/categories.jpg', 'public', 1, 1, '2026-07-24 10:07:52', NULL, NULL, NULL),
(70, '/static/img/2026/07/screenshots/categories-list.jpg', 'categories-list.jpg', 'image/jpeg', 'jpg', 61170, 1280, 720, 'categories-list', 'Screenshot categories-list', NULL, NULL, 'public', 'public', '2026/07/screenshots/categories-list.jpg', 'public', 1, 1, '2026-07-24 10:26:10', NULL, NULL, NULL),
(71, '/static/img/2026/07/screenshots/add-category.jpg', 'add-category.jpg', 'image/jpeg', 'jpg', 52392, 1280, 720, 'add-category', 'Screenshot add-category', NULL, NULL, 'public', 'public', '2026/07/screenshots/add-category.jpg', 'public', 1, 1, '2026-07-24 10:26:10', NULL, NULL, NULL),
(72, '/static/img/2026/07/screenshots/category-frontend.jpg', 'category-frontend.jpg', 'image/jpeg', 'jpg', 134510, 1280, 720, 'category-frontend', 'Screenshot category-frontend', NULL, NULL, 'public', 'public', '2026/07/screenshots/category-frontend.jpg', 'public', 1, 1, '2026-07-24 10:26:10', NULL, NULL, NULL),
(73, '/static/img/2026/07/kategori-organisasi-0ef63d42.jpg', 'kategori-organisasi-0ef63d42.jpg', 'image/jpeg', 'jpg', 73444, 1200, 675, 'Kategori dan Organisasi', 'Kategori dan Organisasi Konten', NULL, NULL, 'public', 'public', '2026/07/kategori-organisasi-0ef63d42.jpg', 'public', 1, 1, '2026-07-24 10:45:07', NULL, NULL, NULL),
(75, '/static/img/2026/07/screenshots/media-list.jpg', 'media-list.jpg', 'image/jpeg', 'jpg', 99424, 1280, 720, 'media-list', 'Screenshot media-list', NULL, NULL, 'public', 'public', '2026/07/screenshots/media-list.jpg', 'public', 1, 1, '2026-07-24 10:47:06', NULL, NULL, NULL),
(76, '/static/img/2026/07/screenshots/media-upload.jpg', 'media-upload.jpg', 'image/jpeg', 'jpg', 42233, 1280, 720, 'media-upload', 'Screenshot media-upload', NULL, NULL, 'public', 'public', '2026/07/screenshots/media-upload.jpg', 'public', 1, 1, '2026-07-24 10:47:06', NULL, NULL, NULL),
(77, '/static/img/2026/07/menu-manager-thumb.jpg', 'menu-manager-thumb.jpg', 'image/jpeg', 'jpg', 54059, 1024, 559, 'Menu Manager Thumbnail', 'Thumbnail for Menu Manager article', NULL, NULL, 'public', 'public', NULL, 'public', 1, 1, '2026-07-24 11:05:59', NULL, NULL, NULL),
...
(81, '/static/img/2026/07/theme-system-thumb.jpg', 'theme-system-thumb.jpg', 'image/jpeg', 'jpg', 52200, 1024, 559, 'Theme System Thumbnail', 'Thumbnail for Theme System article', NULL, NULL, 'public', 'public', NULL, 'public', 1, 1, '2026-07-24 17:36:22', NULL, NULL, NULL),
...
(85, '/static/img/2026/07/plugin-system-thumb.jpg', 'plugin-system-thumb.jpg', 'image/jpeg', 'jpg', 84241, 1280, 1024, 'Plugin System Thumbnail', 'Thumbnail for Plugin System article', NULL, NULL, 'public', 'public', NULL, 'public', 1, 1, '2026-07-24 18:43:04', NULL, NULL, NULL),
...
(89, '/static/img/2026/07/settings-dashboard-thumb.jpg', 'settings-dashboard-thumb.jpg', 'image/jpeg', 'jpg', 40714, 1024, 559, 'Settings Dashboard Thumbnail', 'Thumbnail for Settings Dashboard article', NULL, NULL, 'public', 'public', NULL, 'public', 1, 1, '2026-07-24 19:00:47', NULL, NULL, NULL),
...
(97, '/static/img/2026/07/seo-meta-tags-thumb.jpg', 'seo-meta-tags-thumb.jpg', 'image/jpeg', 'jpg', 58105, 1024, 559, 'SEO Meta Tags Thumbnail', 'Thumbnail for SEO article', NULL, NULL, 'public', 'public', NULL, 'public', 1, 1, '2026-07-24 19:16:07', NULL, NULL, NULL),
...
(100, '/static/img/2026/07/sitemap-screenshot.jpg', 'sitemap-screenshot.jpg', 'image/jpeg', 'jpg', 27344, 1280, 720, 'Sitemap Screenshot', 'sitemap.xml preview', NULL, NULL, 'public', 'public', NULL, 'public', 1, 1, '2026-07-24 19:16:07', '2026-07-24 19:16:16', NULL, NULL),
(101, '/static/img/2026/07/widget-shortcodes-thumb.jpg', 'widget-shortcodes-thumb.jpg', 'image/jpeg', 'jpg', 56811, 1024, 559, 'Widget dan Shortcodes Thumbnail', 'Thumbnail for Widget dan Shortcodes article', NULL, NULL, 'public', 'public', NULL, 'public', 1, 1, '2026-07-24 23:33:31', NULL, NULL, NULL),
...
(109, '/static/img/2026/07/sistem-soft-delete-thumb.jpg', 'sistem-soft-delete-thumb.jpg', 'image/jpeg', 'jpg', 27208, 1024, 559, 'Sistem Soft Delete Thumbnail', 'Thumbnail for Sistem Soft Delete article', NULL, NULL, 'public', 'public', NULL, 'public', 1, 1, '2026-07-25 00:03:17', NULL, NULL, NULL),
...
(111, '/static/img/2026/07/sistem-reinstall-update-thumb.jpg', 'sistem-reinstall-update-thumb.jpg', 'image/jpeg', 'jpg', 46481, 1024, 559, 'Sistem Reinstall Update Thumbnail', 'Thumbnail for Sistem Reinstall dan Update article', NULL, NULL, 'public', 'public', NULL, 'public', 1, 1, '2026-07-25 00:06:50', NULL, NULL, NULL),
...
(113, '/static/img/2026/07/memulai-jyavani-thumb.jpg', 'memulai-jyavani-thumb.jpg', 'image/jpeg', 'jpg', 58828, 1024, 559, 'Memulai dengan Jyavani Thumbnail', 'Thumbnail for Memulai dengan Jyavani article', NULL, NULL, 'public', 'public', NULL, 'public', 1, 1, '2026-07-25 00:09:41', NULL, NULL, NULL),
(114, '/static/img/2026/07/dashboard-screenshot.jpg', 'dashboard-screenshot.jpg', 'image/jpeg', 'jpg', 57561, 1280, 618, 'Dashboard Screenshot', 'Jyavani CMS dashboard screenshot', NULL, NULL, 'public', 'public', NULL, 'public', 1, 1, '2026-07-25 00:09:41', '2026-07-25 08:01:27', NULL, NULL),
...
(117, '/static/img/2026/07/private-files-thumb.jpg', 'private-files-thumb.jpg', 'image/jpeg', 'jpg', 53773, 1280, 853, 'Private Files Thumbnail', 'Thumbnail for Private Files and Media article', NULL, NULL, 'public', 'public', NULL, 'public', 1, 1, '2026-07-25 09:01:03', NULL, NULL, NULL),
(118, '/static/img/2026/07/files-list-screenshot.jpg', 'files-list-screenshot.jpg', 'image/jpeg', 'jpg', 52470, 1280, 618, 'Private Files List Screenshot', 'Private Files list page screenshot', NULL, NULL, 'public', 'public', NULL, 'public', 1, 1, '2026-07-25 09:01:03', NULL, NULL, NULL),
...
(120, '/static/img/2026/07/media-library-thumb-gen.jpg', 'media-library-thumb-gen.jpg', 'image/jpeg', 'jpg', 61674, 1024, 559, 'Media Library Thumbnail', 'Thumbnail for Media Library article', NULL, NULL, 'public', 'public', 'public/static/img/2026/07/media-library-thumb-gen.jpg', 'public', 1, 1, '2026-07-25 09:22:03', '2026-07-25 09:22:03', NULL, NULL),
...
(122, '/static/img/2026/07/og-tags-screenshot.jpg', 'og-tags-screenshot.jpg', 'image/jpeg', 'jpg', 130940, 1280, 720, 'OG Tags Screenshot', 'OG Tags Screenshot', NULL, NULL, 'public', 'public', 'public/static/img/2026/07/og-tags-screenshot.jpg', 'public', 1, 1, '2026-07-25 09:29:42', '2026-07-25 09:29:42', NULL, NULL),
...
(126, '/static/img/2026/07/user-roles-screenshot.jpg', 'user-roles-screenshot.jpg', 'image/jpeg', 'jpg', 71918, 1274, 1190, 'User Roles Screenshot', 'User Roles Screenshot', NULL, NULL, 'public', 'public', 'public/static/img/2026/07/user-roles-screenshot.jpg', 'public', 1, 1, '2026-07-25 09:29:42', '2026-07-25 09:29:42', NULL, NULL),
...
(296, 2, 1, '2026-09-13 22:30:00'),
(296, 4, 1, '2026-09-13 22:30:00');
